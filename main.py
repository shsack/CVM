...
def run(omega, eta, max_iter, tol, i, j, maxm, cut):

    """Run the executable generated by the C++ file"""

    os.system("./{} {} {} {} {} {} {} {} {}".format(exe_name, omega, eta, max_iter, tol, i, j, maxm, cut))
...
for o in omega:
    ...
    run(omega=o, eta=0.05, max_iter=50, tol=1E-5, i=1, j=1, maxm=20, cut=1E-6)
